...
<div class="image_content">
    <div class="text_title_1">СИМУЛЯТОРИ EA</div>
</div>

<div class="text_bellow_tittle">
    Завдяки симуляторам EA гравці можуть повністю поринути у гру та дати волю фантазії.
    Грайте з життям у The Sims 4, демонструйте першокласний футбол у легендарній серії FIFA або будуйте квітучий мегаполіс у SimCity.
    У всіх цих іграх є елементи реального життя, а рішення стоять виключно за вами.
</div>
<div class="catalog_container">
    <?php
    $conn = new mysqli("localhost", "rokhopper", "1234", "games");
    $sql = "SELECT * FROM simulators";
