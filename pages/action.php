...
<div class="image_content">
    <div class="text_title_1">ІГРИ В ЖАНРІ ЕКШН ВІД EA</div>
</div>

<div class="text_bellow_tittle">
    Від гоночних трас до далеких куточків галактики - у EA є різні ігри, які викличуть у вас приплив адреналіну.
    Вирушайте в міжгалактичну пригоду в «Зоряні Війни Джедаї: Загиблий Орден»™, вийдіть на арену і покажіть свою майстерність в Apex Legends,
    одягніться в джавелін і досліджуйте небезпечний світ Anthem або пориньте в інші приголомшливі пригодницькі відеоігри.
</div>
