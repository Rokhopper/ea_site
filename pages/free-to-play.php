...
<div class="image_content">
    <div class="text_title_1">БЕЗКОШТОВНІ ІГРИ EA</div>
</div>

<div class="text_bellow_tittle">
    Пориньте в гру вдома чи в дорозі з переліком безкоштовних ігор EA на консолях, ПК та мобільних пристроях.
    Вибирайте із розбійників, солдатів, невдач і мізантропів, а потім боріться до вершини в Apex Legends.
    Створіть свою Ultimate Team, а потім вирушайте на поле, щоб взяти участь у змаганнях у FIFA Mobile.
    Збирайте своїх улюблених героїв (і лиходіїв) з усіх епох і перемагайте супротивників в епічних битвах у стилі RPG у Star Wars™: Galaxy of Heroes.
    З цими чудовими безкоштовними іграми веселощі тільки починаються!
</div>
