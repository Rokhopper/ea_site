...
<div class="image_content">
    <div class="text_title_1">МУЗИЧНІ ІГРИ ВІД EA</div>
</div>

<div class="text_bellow_tittle">
    Рухайтеся під музику та дозвольте ритму керувати вами у наших енергійних музичних іграх.
    Співайте, танцюйте, відчуйте себе справжньою зіркою, поки ви веселитесь під запальну музику.
    Відкрийте в собі нові грані таланту в Boogie, грі про танці та співи. Купайтеся в променях слави та записуйте свої найкращі виступи!
</div>
<div class="catalog_container">
    <?php
    $conn = new mysqli("localhost", "rokhopper", "1234", "games");
    $sql = "SELECT * FROM music_games";
