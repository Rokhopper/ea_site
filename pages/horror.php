...
<div class="image_content">
    <div class="text_title_1">ЖАХІТТЯ ВІД EA</div>
</div>

<div class="text_bellow_tittle">
    Щось прослизнуло за рогом. Світло блимає, коли ви спускаєтеся сходами.
    Перевірте, наскільки ви хоробри в наших жахливих, що леденять душу.
    Чи боретесь ви з жахливими інопланетними істотами або з гарячковими породженнями свого власного розуму, у кожному жахітті на вас чекають свої сюрпризи.
    Загартуйте свій дух, борючись з нескінченним кошмаром в Dead Space 3 в ролі Айзека Кларка, інженера, який має покінчити з атаками некроморфів, або виберіть іншу жахливу гру.
</div>
