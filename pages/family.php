...
<div class="image_content">
    <div class="text_title_1">СІМЕЙНІ ІГРИ ВІД EA</div>
</div>

<div class="text_bellow_tittle">
    З сімейними іграми EA кожен знайде для себе щось цікаве. Вирушайте в приголомшливі пригоди з чарівним Ярні в Unravel або спіймайте іскру разом з другом в Unravel Two.
    Виберіть бік у найшаленішому і найрозкішнішому шутері у світі — Plants vs. Zombies Garden Warfare 2. На вас чекає багато всього цікавого в нашій бібліотеці ігор!
</div>
<div class="catalog_container">
    <?php
    $conn = new mysqli("localhost", "rokhopper", "1234", "games");
    $sql = "SELECT * FROM family_games";
