...
<div class="image_content">
    <div class="text_title_1">СТРАТЕГІЇ EA</div>
</div>

<div class="text_bellow_tittle">
    Якщо ви хочете досягти успіху в наших стратегіях, доведеться добре розкинути мізками.
    Побудуйте власну імперію, обійдіть своїх суперників або контролюйте ситуацію і прийдіть до перемоги.
    Побудуйте сліпучий мегаполіс у найкращому містобудівному симуляторі всіх часів Sim City.
    Або продумайте свою стратегію в мобільних іграх: створіть загін для підкорення галактики в "Зоряні війни: Галактика героїв" або воюйте за газон Plants vs Zombies Heroes.
    Наші стратегії доступні як на ПК, так і мобільних пристроях.
</div>
