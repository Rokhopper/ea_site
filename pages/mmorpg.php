...
<div class="image_content">
    <div class="text_title_1">MMORPG ВІД EA</div>
</div>

<div class="text_bellow_tittle">
    Воюйте по мережі з гравцями з усього світу в наших іграх у жанрі MMORPG.
    Чи ведете ви свою команду до перемоги, чи просто веселитесь з друзями — ми завжди знайдемо для вас щось цікаве.
    Зіграйте в Star Wars: The Old Republic, найкращу MMORPG у всесвіті Star Wars, і завоюйте панування в галактиці.
</div>
<div class="catalog_container">
    <?php
    $conn = new mysqli("localhost", "rokhopper", "1234", "games");
    $sql = "SELECT * FROM mmorpg";
