...
<div class="image_content">
    <div class="text_title_1">ПРИГОДНИЦЬКІ ІГРИ ВІД EA</div>
</div>

<div class="text_bellow_tittle">
    Мандруйте дивними новими світами або розширте межі власного разом з нашою бібліотекою неймовірних пригодницьких ігор.
    Беріть участь у міжгалактичних битвах у Star Wars™ Battlefront II,
    приборкайте потужний джавелін і врятуйте людство в Anthem і станьте джедаєм у «Зоряні Війни Джедаї: Загиблий Орден»™.
    У EA знайдеться маса ігор, щоб вгамувати вашу спрагу пригод!
</div>
<div class="catalog_container">
    <?php
    $conn = new mysqli("localhost", "rokhopper", "1234", "games");
    $sql = "SELECT * FROM advanture";
